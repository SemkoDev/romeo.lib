...
describe('db', () => {
  ...
  it('should use the correct key', () => {
    expect(db._key('test'))
      .to.equal('COHTERXSNTZDXITLQHMHM9FTFHJJCGO9WDYQLODYTXUPJBFESXVOGY9NYMOAWLQXXLJHTSJANFQ9WXDHC');
  });
  ...
  it('should backup and restore correctly', (done) => {
    ...
    Promise.all(Object.keys(testData).map((key) => db.put(key, testData[key])))
      .then(() => {
